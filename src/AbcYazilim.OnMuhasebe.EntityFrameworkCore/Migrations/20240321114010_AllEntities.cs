        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    VergiNo = table.Column<string>(type: "VarChar(50)", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Barkod = table.Column<string>(type: "VarChar(128)", maxLength: 128, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HesapNo = table.Column<string>(type: "VarChar(26)", maxLength: 26, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BankaToplam = table.Column<byte>(type: "TinyInt", nullable: false),
                    OzelKod1Id = table.Column<Guid>(type: "UniqueIdentifier", nullable: true),
                    OzelKod2Id = table.Column<Guid>(type: "UniqueIdentifier", nullable: true),
                    SubeId = table.Column<Guid>(type: "UniqueIdentifier", nullable: false),
                    DonemId = table.Column<Guid>(type: "UniqueIdentifier", nullable: false),
