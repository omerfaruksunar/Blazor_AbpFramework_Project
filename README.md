...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a521d2b6-b3bf-4225-a86c-ed01700b1c26
```

> `a521d2b6-b3bf-4225-a86c-ed01700b1c26` is the password of the certificate, you can change it to any password you want.
