...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p d324b22d-6c06-413f-a851-f8d3128e4f10
```

> `d324b22d-6c06-413f-a851-f8d3128e4f10` is the password of the certificate, you can change it to any password you want.
